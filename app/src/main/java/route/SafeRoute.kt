        ...
        if (roadType != null) {
            when (roadType) {
                ...
                24 -> {//쾌적 X 도로 :  배점 ) 50
                    ...
                    routeInfor.roadScore_draft = routeInfor.roadScore_draft?.plus(distance!!*0) }
